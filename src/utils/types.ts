...
export const GAME_DEFINITIONS: GameDefinition[] = [
  ...
  { id: 'racerwords', title: 'Racer Words', emoji: '🏎️', description: 'Race cars by answering right!', color: '#EF4444', bgColor: 'from-red-500 to-orange-600' },
  { id: 'targetblast', title: 'Target Blast', emoji: '🎯', description: 'Splash the right target!', color: '#8B5CF6', bgColor: 'from-violet-500 to-purple-700' },
  { id: 'troopmarch', title: 'Troop March', emoji: '🪖', description: 'Build your soldier parade!', color: '#059669', bgColor: 'from-emerald-600 to-green-800' },
  { id: 'rocketlaunch', title: 'Rocket Launch', emoji: '🚀', description: 'Fuel your rocket to space!', color: '#7C3AED', bgColor: 'from-indigo-600 to-violet-900' },
  { id: 'treasuremap', title: 'Treasure Map', emoji: '🗺️', description: 'Find the hidden treasure!', color: '#D97706', bgColor: 'from-amber-500 to-yellow-700' },
